...
describe("showSection", () => {
  test("null namedMode", () => {
    const out = showSection("foo", null)

    expect(out).toBeTruthy()
  })

  test("empty namedMode", () => {
    const out = showSection("foo", ["name", {}])
...
describe("filterSection", () => {
  ...
  test("null namedMode", () => {
    const out = filterSection("foo", configSpec, null, x => true)
  ...
  test("empty namedMode", () => {
    const out = filterSection("foo", configSpec, ["name", {}], x => true)
