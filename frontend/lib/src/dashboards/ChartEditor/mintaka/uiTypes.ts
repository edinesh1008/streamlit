...
import { LayerState } from "./stateTypes.js"
...
export interface SectionContainerProps<S>
...
export type ItemizedWidgetHint = "multiselect" | "select" | "toggle"
...
export type GenericPickerWidget<V, S> = FunctionComponent<
  GenericPickerWidgetProps<V, S>
>
