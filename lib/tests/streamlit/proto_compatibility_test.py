    ...
    [
        ...
        (
            CustomThemeConfig,
            {
                ...
                ("info_text_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("info_background_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("error_text_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("error_background_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("success_text_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("success_background_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("warning_text_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
                ("warning_background_color", FD.LABEL_OPTIONAL, FD.TYPE_STRING),
